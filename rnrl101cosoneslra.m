function [os,xs,Vs,ds,wbcos,P] = rnrl101cosoneslra(abase,g,ndim,nt,P,plotyn)

% rnrl101cosoneslra: feedback rand*(1, 1, ..., 1) for modeltype: 4:VRNNrf
...
% C     R     e e e  e
%
%   [os,xs,Vs,ds,wbcos,P] = rnrl101cosoneslra(0.1,0.8,12,1500,[],1);
...
w = zeros(1,ndim);
b = rand * ones(1,ndim); % feedback (non-negative)
