function [os,xs,Vs,ds,wbcos,P] = rnrl101cosdistlra(modeltype,abase,g,ndim,nt,pdist,P,plotyn)

% rnrl101cosdistlra : with distractor cue
...
% C     R     e e e  e
%
%   [os,xs,Vs,ds,wbcos,P] = rnrl101cosdistlra(4,0.1,0.8,12,1500,0.1,[],1);
...
if isempty(P)
    P = randn(ndim,ndim+3); % combined A and B
end
w = zeros(1,ndim);
