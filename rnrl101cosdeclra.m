function [os,xs,Vs,ds,w,wbcos,P] = rnrl101cosdeclra(modeltype,abase,g,decay_rate,ndim,nt,P,plotyn)
...
% C     R     e e e  e
%
%   [os,xs,Vs,ds,w,wbcos,P] = rnrl101cosdeclra(4,0.1,0.8,0.001,12,1500,[],1);
