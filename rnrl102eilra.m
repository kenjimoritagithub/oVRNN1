function [os,xs,xis,Vs,ds,trialtypes,P] = rnrl102eilra(modeltype,tasktype,abase,g,ndim,nt,P,plotyn)
...
% C   r   r   e e e  e
%
%   [os,xs,xis,Vs,ds,trialtypes,P] = rnrl102eilra(4,1,0.1,0.8,20,2000,[],1);
